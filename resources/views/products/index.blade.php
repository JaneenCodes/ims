                    ...
                    <div class="d-flex justify-content-end mb-6 mb-3">
                        @auth
                            @if(auth()->user()->role == 'admin')
                                <button type="button" class="create-btn btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#crud-modal">
                                    + Create New Product
                                </button>
                            @endif
                        @endauth
                                    ...
                                    <tr class="hover-bg-light product-list">
                                        ...
                                        @auth
                                            ...
                                            <td class="text-center">
                                                ...
                                                class="view-btn btn btn-warning btn-sm rounded-pill" 
                                                data-url="">View
                                                </a> 
